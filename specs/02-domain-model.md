...
Editing a feed source's URL must null both `sources` columns: a stored validator is only meaningful
against the origin that issued it, and a changed feed URL is a new origin.
