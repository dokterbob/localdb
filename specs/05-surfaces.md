...
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `init [--download-model]`                                  | Optional bootstrap: scaffolds config + data/models/logs dirs and prints every resolved path, ensures a `default` store exists (skipped with a warning if the database cannot be opened — e.g. it needs a schema migration), and with `--download-model` prepares the configured embedder now instead of on the first `index`/`search`. Every other command scaffolds implicitly on first use (§2.5) — `init` is **never a prerequisite**. Not store-scoped, `-s` is rejected, exit 2 (§2.2) | full                                                                                                      | n/a (never contacts the daemon)                                                                                                                                                                                                                                                                       |
